#!/bin/bash
#
# Remove all users specified in the file passed as command-line argument from the hub.
...
# call script to delete user account from jupyterhub
${base_dir}/hub_delete_users.sh ${userlist}

# call script to delete user from load balancer
${base_dir}/haproxy_delete_users.sh ${userlist}
